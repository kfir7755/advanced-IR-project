...
def average_results(dataset):
    path = os.path.join('results', dataset, 'full_fusion')
    ...
    print(averaged, '\n'*5)
    averaged.to_latex(os.path.join('results', dataset, 'averaged_results.tex'), float_format='%.3f', na_rep='-', multicolumn_format='c')
