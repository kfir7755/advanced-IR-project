...
for dataset in datasets:
    ...
    if not os.path.exists(os.path.join("data", dataset, "per_query_qrels")):
        os.mkdir(os.path.join("data", dataset, "per_query_qrels"))
        ...
        # Usage
        input_file = os.path.join("data", dataset, f"{dataset.lower()}03_qrels.txt")
        output_dir = os.path.join("data", dataset, "per_query_qrels")
